...
import { AppBar, Box, CssBaseline, Toolbar, useMediaQuery, Drawer } from '@mui/material';
      ...
      <body>
        <ThemeRegistry options={{ key: 'mui' }}>
          <Box sx={{ display: 'flex' }}>
            ...
            {/* <Drawer anchor={'right'} open={leftDrawerOpened} onClose={handleLeftDrawerToggle}>
              ??
            </Drawer> */}

            {/* main content */}
            {/* <Main theme={theme} open={leftDrawerOpened}> */}
            <Main open={leftDrawerOpened}>{children}</Main>
          </Box>
        </ThemeRegistry>
      </body>
    </html>
